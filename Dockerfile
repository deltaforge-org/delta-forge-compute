...
LABEL org.opencontainers.image.title="DeltaForge Compute" \
      org.opencontainers.image.description="Native lakehouse engine for Delta Lake and Apache Iceberg" \
      org.opencontainers.image.vendor="DeltaForge" \
      org.opencontainers.image.url="https://deltaforge.org" \
      org.opencontainers.image.documentation="https://deltaforge.org/docs" \
      org.opencontainers.image.source="https://github.com/deltaforge-org/delta-forge-compute" \
      org.opencontainers.image.licenses="LicenseRef-DeltaForge-Proprietary"
